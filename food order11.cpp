...
void one::menu1()
{
	...
	cout<<"\n\n\n\t===========================\t\t\t==========================\t\t\t\t==========================="<<endl;
	cout<<"\t[1] Veggie Supreme (Ksh.480)\t\t\t[2] Exotica Pizza(Ksh.440)\t\t\t\t[3] Chicken Sizzler (Ksh.580)\n\t[4] Chrispy Chicken (Ksh.520)\t\t\t[5] Spaghetti (Ksh.350)\t\t\t\t\t[6] Country Feast (Ksh.400)\n\t[7] Tetrazzini (Ksh.420)\t\t\t\t[8] Double Cheese (Ksh.540)\t\t\t\t[9] Makizushi (Ksh.548)\n\t[10] Ham Burger (Ksh.390)\t\t\t[11] Margherita Pizza(Ksh.525)\t\t\t\t[12] Fish 'n' Chips (Ksh.425)\n\t[13] Fajitas (Ksh.335)\t\t\t\t[14] Tempura (Ksh.324)\t\t\t\t\t[15] Hot Dog (Ksh.360)\n\t===========================\t\t\t==============================\t\t\t\t===========================\n\n\n\t\t\t\t\t\t\t\t[16] EXIT"<<endl;
 cout<<"\n\t======================================================================================================================================="<<endl;
}
  ...
  else
  {
   switch(ch)
   {
	...
	cout<<"\n\n\tHOW MANY MAKIZUSHI YOU WANT :";
   	...
   	case 16:
   		cout<<"\n\t\t\t\t\t Brought To You By delicart";
   	exit(0);
   	break;
   	
   	default:
   		cout<<"\n\n\t\t\t\t\t\t\tYOU'VE' ENTERED WRONG ORDER KEY !!!!! "<<endl;
   		goto c;
   		break;
   }
...
system("cls");
						...
						cout << endl;
						cout << endl;
						cout << "\t\t\t\t\t\t\t  Cashier :  Joe Doe"<<endl;
						cout << endl;
                        cout<<"\t\t\t\t\t\t\t\t    YOUR TOTAL BILL IS Ksh."<<s<<endl;
                        write<<"\t\t\t\t\t\t\t ";
